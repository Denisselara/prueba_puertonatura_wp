...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20181219_puertonatura_82bf69bf90dfd3b06698_20181219020604_archive.zip';
	const ARCHIVE_SIZE		 = '62577238';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '82bf69b-19020604';
	const VERSION			 = '1.3.0';
